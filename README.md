...
| :--- | :--- | :--- | :--- |
| 🪟 **Windows** | **`.exe` Kurulum Sihirbazı** | [📥 **PostgreSQL-DDL-Studio-Setup-5.5.2.exe**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/PostgreSQL-DDL-Studio-Setup-5.5.2.exe) | ⭐ **Önerilen**: İleri-İleri Kurulum Sihirbazı, Masaüstü/Başlat Simgeleri |
| 🍏 **macOS** | **`.dmg` Yükleyici** | [📥 **PostgreSQL-DDL-Studio-5.5.2-macOS.dmg**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/PostgreSQL-DDL-Studio-5.5.2-macOS.dmg) | Apple Silicon (M1-M4) & Intel, Sürükle-Bırak Kurulum |
| 🐧 **Linux** | **`.deb` Kurulum Paketi** | [📥 **PostgreSQL-DDL-Studio-5.5.2-Linux.deb**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/PostgreSQL-DDL-Studio-5.5.2-Linux.deb) | ⭐ Kali, Ubuntu, Debian için tek tıkla kurulum |
| 🐧 **Linux** | **Taşınabilir `.tar.gz`** | [📥 **PostgreSQL-DDL-Studio-5.5.2-Linux.tar.gz**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/PostgreSQL-DDL-Studio-5.5.2-Linux.tar.gz) | Kali, Ubuntu, Debian, Fedora, Arch (`run.sh` / `install.sh`) |
| 🪟 **Windows** | **Taşınabilir `.zip`** | [📥 **PostgreSQL-DDL-Studio-5.5.2-Windows.zip**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/PostgreSQL-DDL-Studio-5.5.2-Windows.zip) | Kurulum gerektirmeyen taşınabilir (Portable) paket |
| ☕ **Evrensel JAR** | **Fat `.jar`** | [📥 **postgres_ddl_export_console_java-1.0.0.jar**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/postgres_ddl_export_console_java-1.0.0.jar) | Tüm platformlar, CLI ve Sunucu otomasyonu |
| 🔒 **Güvenlik** | **SHA-256 Sağlama** | [📄 **SHA256SUMS.txt**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.5.2/SHA256SUMS.txt) | Kriptografik bütünlük doğrulama |
