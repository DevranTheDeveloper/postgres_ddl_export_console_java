...
| :--- | :--- | :--- | :--- |
| 🪟 **Windows** | **`.exe` Kurulum Sihirbazı** | [📥 **PostgreSQL-DDL-Studio-Setup-5.6.0.exe**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio-Setup-5.6.0.exe) | ⭐ **Önerilen**: İleri-İleri Kurulum Sihirbazı, Sessiz Başlatıcı (0 CMD Window) |
| 🍏 **macOS** | **`.dmg` Yükleyici** | [📥 **PostgreSQL-DDL-Studio-5.6.0-macOS.dmg**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio-5.6.0-macOS.dmg) | Apple Silicon & Intel, Sürükle-Bırak Kurulum & Güvenlik Sihirbazı |
| 🐧 **Linux** | **`.deb` Kurulum Paketi** | [📥 **PostgreSQL-DDL-Studio-5.6.0-Linux.deb**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio-5.6.0-Linux.deb) | ⭐ Kali, Ubuntu, Debian için tek tıkla kurulum |
| 🐧 **Linux** | **Taşınabilir `.tar.gz`** | [📥 **PostgreSQL-DDL-Studio-5.6.0-Linux.tar.gz**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio-5.6.0-Linux.tar.gz) | Kali, Ubuntu, Debian, Fedora, Arch (`run.sh` / `install.sh`) |
| 🪟 **Windows** | **Taşınabilir `.zip`** | [📥 **PostgreSQL-DDL-Studio-5.6.0-Windows.zip**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio-5.6.0-Windows.zip) | Kurulum gerektirmeyen taşınabilir (Portable) sessiz paket |
| ☕ **Evrensel JAR** | **Fat `.jar`** | [📥 **PostgreSQL-DDL-Studio.jar**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/PostgreSQL-DDL-Studio.jar) | Tüm platformlar, CLI ve Sunucu otomasyonu |
| 🔒 **Güvenlik** | **SHA-256 Sağlama** | [📄 **SHA256SUMS.txt**](https://github.com/DevranTheDeveloper/postgres_ddl_export_console_java/releases/download/v5.6.0/SHA256SUMS.txt) | Kriptografik bütünlük doğrulama |
