...
public class LogPanel extends JPanel {
    ...
    public void appendLog(String message) {
        ...
        SwingUtilities.invokeLater(() -> renderLogLine(message));
    }

    private void renderLogLine(String message) {
        try {
            ...
            Color textColor = isDark ? new Color(240, 245, 255) : new Color(31, 41, 55); // High contrast light text in dark mode
    ...
    public void applyTheme(boolean isDark) {
        this.isDark = isDark;
        if (isDark) {
            textPane.setBackground(new Color(24, 26, 32));
            textPane.setCaretColor(Color.WHITE);
            textPane.setForeground(new Color(240, 245, 255));
